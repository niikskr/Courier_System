<%-- 
    Document   : Emp_del
    Created on : Mar 12, 2016, 1:34:53 PM
    Author     : badal
--%>
...
<body>
    <form name="frm" action="emp_dl_db.jsp">
...
<input type="submit" id="Button1" name="" value="Delete" style="position:absolute;left:282px;top:511px;width:166px;height:36px;z-index:33;">
