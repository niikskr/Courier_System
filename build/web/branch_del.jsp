<%-- 
    Document   : branch_del
    Created on : Mar 13, 2016, 8:29:31 AM
    Author     : badal
--%>
...
<body>
    <form name="frm" action="agent_del_db.jsp">
...
<input type="submit" id="Button1" name="" value="Delete" style="position:absolute;left:163px;top:531px;width:180px;height:60px;z-index:17;">
